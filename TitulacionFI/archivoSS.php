<?php
	...
	if($id > 0){
		$sqlArc = "SELECT nombre, coalesce(archivo_ss, -1) as archivo_ss, tipo_mime, size FROM alumno_ss WHERE alumno_no_cuenta = ".$cuenta;
		...
		pg_query($cx, "begin");
		$file = pg_lo_open($cx, $datos['archivo_ss'], "r");
